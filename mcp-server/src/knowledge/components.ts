...
/>`,
  ...
  // =========================================================================
  {
    ...
    props: [
      ...
      { name: "tooltipHint", type: "boolean | string", required: false, description: "Show action hint at bottom of tooltip. true: auto ('Click to drill down' / 'Click to filter'). string: custom hint text. false: disable. Default: respects MetricConfig.tooltipHint (true)." },
...
<DrillDown.Root>
  ...
  // =========================================================================
  {
    ...
    props: [
      ...
      { name: "sticky", type: "boolean", required: false, default: "false", description: "Stick to viewport top when scrolling. Adds frosted-glass backdrop blur with 12px top offset." },
