    ...
    <div className="flex">
      <div className="min-w-0 flex-1 px-8 py-8 lg:max-w-3xl">
        ...
        <p className="mt-3 max-w-2xl text-[15px] leading-relaxed text-[var(--muted)]">
          MetricUI works with every major AI coding tool. Connect the MCP server for the
          best experience, or point any AI at llms.txt for instant component knowledge.
        </p>
