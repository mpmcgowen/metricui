...
export default function FilteringGuide() {
  return (
    <DocPageLayout tocItems={tocItems} maxWidth="prose">
      <GuideHero
        title="Filtering"
        description="MetricUI filter components are pure UI. They capture what the user selected — a date range, a comparison mode, a dimension value — and expose it via context. They never touch, fetch, or transform your data."
      />
