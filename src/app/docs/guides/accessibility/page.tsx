...
export default function AccessibilityGuide() {
  return (
    <DocPageLayout tocItems={tocItems} maxWidth="prose">
      <GuideHero
        title="Accessibility"
        description="MetricUI is built with accessibility in mind. Every component supports keyboard navigation, ARIA attributes, and respects user motion preferences."
      />
