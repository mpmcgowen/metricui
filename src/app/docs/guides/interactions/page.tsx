...
export default function InteractionsGuide() {
  return (
    <DocPageLayout tocItems={tocItems} maxWidth="prose">
      <GuideHero
        title="Interactions"
        description={`Visual coordination between dashboard components. Linked hover syncs crosshairs across charts. Value flash highlights data changes in real time. For click-based filtering, see Cross-Filtering in the Filtering guide.`}
      />
