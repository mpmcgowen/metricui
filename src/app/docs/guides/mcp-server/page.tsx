...
export default function McpServerGuide() {
  return (
    <DocPageLayout tocItems={tocItems} maxWidth="prose">
      <GuideHero
        title="MCP Server"
        description="The MetricUI MCP server gives AI coding tools structured knowledge of every component, every prop, and every pattern — so they generate production-quality dashboards on the first try."
      />
