...
export default function DataFormatGuide() {
  return (
    <DocPageLayout tocItems={tocItems} maxWidth="prose">
      <GuideHero
        title="Data Format"
        description={`MetricUI charts accept a simple, flat data format. Pass an array of rows with an index column and categories — the same data works across every chart type.`}
      />
